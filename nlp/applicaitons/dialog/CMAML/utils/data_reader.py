...
def cluster_persona(data, split):
    ...
    filename = 'CMAML/data/ConvAI2/'+split+'_persona_map'
...
def prepare_data_seq():
    file_train = 'CMAML/data/ConvAI2/train_self_original.txt'
    file_dev = 'CMAML/data/ConvAI2/valid_self_original.txt'
    file_test = 'CMAML/data/ConvAI2/test_self_original.txt'
    cand = {}
        ...
        if(len(dial_persona)==1 and split == "train"):
            ...
            for i in dial_persona:
                if(i == val_dial):
                    ...
                    for p in dial_persona[i]:
                        tr.append(p)
        with open('train_new.json','a') as f1:
            json.dump(val,f1)
        with open('val_new.json','a') as f2:
            json.dump(val,f2)
        with open('val','ab') as f3:
            pickle.dump(val,f3)
