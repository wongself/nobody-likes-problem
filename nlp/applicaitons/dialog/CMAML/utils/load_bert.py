...
class bert_model(object):
	def __init__(self):
		...
		self.tokenizer = BertTokenizer.from_pretrained('CMAML/tmp/bert-base-uncased-vocab.txt', do_lower_case=True)

		# Load a trained model that you have fine-tuned
		output_model_file = os.path.join("CMAML/data/nli_model/", "pytorch_model.bin")
		model_state_dict = torch.load(output_model_file)
		model = BertForSequenceClassification.from_pretrained('CMAML/tmp/bert-base-uncased.tar.gz', state_dict=model_state_dict, num_labels=self.num_labels)
