...
from .entity import Dataset, EntityType, RelationType, Entity, Relation, Document
from . import util


class BaseInputReader(ABC):
    def __init__(self, types_path: str, tokenizer: BertTokenizer, neg_entity_count: int = None, neg_rel_count: int = None, max_span_size: int = None):  # noqa
...
class JsonInputReader(BaseInputReader):
    ...
    def read(self, dataset_paths):
        for dataset_label, jdocument in dataset_paths.items():
            dataset = Dataset(
                dataset_label,
    ...
    def _parse_paragraph(self, doc, dataset) -> Document:
        jtokens = doc['tokens']
